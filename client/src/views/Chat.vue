	...
	<div class="chat-page">
		<div v-if="!userRef" class="welcome">
			...
			<div class="input-bar">
				...
				<a class="btn" @click="handleNameEnter">Chat</a>
			</div>
		...
		<div v-else class="auth">
			<div v-if="!userRef.rcptName" class="finding">
				...
				<a class="btn" @click="handleDelete">Back</a>
			</div>
			<div v-else class="found">
				<div class="info-bar">
					<div class="rcpt-name">Chat with {{ userRef.rcptName }}</div>
					<a class="btn" @click="handleLeave">New</a>
					<a class="btn" @click="handleDelete">Reset</a>
				</div>
				...
				<div class="input-bar">
					<input id="message-input" v-model="msgRef" @keyup.enter="handleSend" placeholder="Aa" />
					<a class="btn" @click="handleSend">Send</a>
				</div>
			</div>
		</div>
	</div>
